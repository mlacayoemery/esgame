...
THE RULES, all read off the frontend rather than assumed:
  ...
  * The board is 28 x 29 cells (dataAgDynamic.json), a piece is 2 x 2 (``elementSize``), and each
...
ASSET = os.path.join(ROOT, "v2", "src", "assets", "optimalAgDynamic.json")

# The frontend's production type ids, against this pack's. dataAgDynamic.json productionTypes.
