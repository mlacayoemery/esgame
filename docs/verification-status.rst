...
.. list-table::
   ...
   * - Path
     - How it was checked
   * - Static / grid game
     - 407 unit tests, 24 Playwright e2e, Lighthouse a11y 100 / best-practices 100 /
...
A second shape, found 2026-08-07 — *the check was sound and could not run*
   ...
   **Two more of the same shape, in the same workflow — found by re-auditing rather than by
   ...
   .. code-block:: text
      ...
      The documented test count is current   compares "407 unit tests" against the suite
      The documented e2e count is current    compares "24 Playwright e2e" against the suite
